...
def view_pycontext_output(input, vis=Vis('KB/fam_modifiers.tsv')):
	if input is None:
...
def view_pycontext_outputs(processed_docs, vis=Vis('KB/fam_modifiers.tsv')):
	doc_names = []
	docs_text = {}
	annotation_counts = {}
...
def view_pycontext_single_output(processed_doc, vis=Vis('KB/fam_modifiers.tsv')):
