...
This project demonstrates how to use pyConText to identify the patients with family history of breast cancer and colon cancer, with nice real time visualization adopted from Brat's design [2]. For example，
